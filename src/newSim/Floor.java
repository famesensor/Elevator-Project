...
//            PersonUp = avaiable - upWaiting.size();
            PersonUp = 0;
        }
        synchronized (upWaiting) {
            ...
            floorStatus = 1;
//            System.out.println("up " + upWaiting.size() + "Floor " + this.floorNumber);
        }
    }
...
//            PersonDown = avaiable - downWaiting.size();
            PersonDown = 0;
        }
        synchronized (downWaiting) {
            ...
            floorStatus = -1;
//            System.out.println("down " + downWaiting.size() + "Floor " + this.floorNumber);
        }
